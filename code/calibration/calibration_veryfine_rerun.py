...
ensmbl_dst = '../../data/calibration/simulation_results/ensembles_veryfine_rerun'
...
contact_weights_fine = np.asarray([0.27])
...
results.to_csv(join(dst,'calibration_results_veryfine_rerun_sampling_{}_{}.csv'\
