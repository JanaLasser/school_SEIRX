...
ensmbl_dst = '../../data/calibration/simulation_results/ensembles_large'
...
if opt_far_contact_weight_coarse == 'prespecified':
    ...
    intermediate_contact_weights_large_ensmbl = np.hstack([
        np.arange(opt_intermediate_contact_weight_coarse - 0.2, 
...
results.to_csv(join(dst,'calibration_results_large_sampling_noage_{}_{}.csv'\
