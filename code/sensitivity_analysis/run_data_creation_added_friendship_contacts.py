...
def sample_prevention_strategies(screen_params, school, agent_types, measures, 
    ...
    ttype, index_case, s_screen_interval, t_screen_interval, student_mask, \
                teacher_mask, half_classes, friendship_ratio,\
    ...
    measure_string = '{}_test-{}_turnover-{}_index-{}_tf-{}_sf-{}_tmask-{}'\
        .format(stype, test, turnover, index_case[0], t_screen_interval,
                ...
                '_smask-{}_fcontacts-{}_half-{}_vent-{}'\
        .format(bmap[student_mask], friendship_ratio, 
        ...
        while i < 10 and found[stat] == False:
            try:
                ...
                af.dump_JSON(path, school, ttype, index_case, s_screen_interval, 
                             ...
                             friendship_contacts=friendship_ratio)
...
# (ttype, index_case, s_creen, t_screen, s_mask, t_mask, half, friendship_contacts, vent)
screening_params = [ 
  # added friendship contacts
  ('same_day_antigen', 'student', None, None, False, False, False, 0.05, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.05, 1),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.1, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.1, 1),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.15, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.15, 1),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.2, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.2, 1),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.25, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.25, 1),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.3, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.3, 1),
  # ventilation + masks teachers AND students + halved classes
  ('same_day_antigen', 'student', None, None, True, True, True, 0.05, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.05, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.1, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.1, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.15, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.15, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.2, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.2, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.25, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.25, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, True, 0.3, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, True, 0.3, 0.36),
  # ventilation + testing 2x / week teachers AND students
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.05, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.05, 0.36),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.1, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.1, 0.36),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.15, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.15, 0.36),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.2, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.2, 0.36),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.25, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.25, 0.36),
  ('same_day_antigen', 'student', 3, 3, False, False, False, 0.3, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, False, False, False, 0.3, 0.36),
  # ventilation + testing 2x /week + masks teachers AND students
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.05, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.05, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.1, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.1, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.15, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.15, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.2, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.2, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.25, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.25, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.3, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.3, 0.36),
  # all measures
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.05, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.05, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.1, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.1, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.15, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.15, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.2, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.2, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.25, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.25, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, True, 0.3, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, True, 0.3, 0.36),
]
