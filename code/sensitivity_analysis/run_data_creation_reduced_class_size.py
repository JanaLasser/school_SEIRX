...
def sample_prevention_strategies(screen_params, school, agent_types, measures, 
    ...
    ttype, index_case, s_screen_interval, t_screen_interval, student_mask, \
                teacher_mask, half_classes, class_size_reduction,\
...
# (ttype, index_case, s_creen, t_screen, s_mask, t_mask, half, class_size_reduction, vent)
screening_params = [ 
  # reduced class sizes
  ...
  ('same_day_antigen', 'student', None, None, False, False, False, 0.4, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.4, 1),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.5, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.5, 1),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.6, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.6, 1),
  ('same_day_antigen', 'student', None, None, False, False, False, 0.7, 1),
  ('same_day_antigen', 'teacher', None, None, False, False, False, 0.7, 1),
  # ventilation + masks teachers AND students + reduced class size
  ('same_day_antigen', 'student', None, None, True, True, False, 0.1, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, False, 0.1, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, False, 0.2, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, False, 0.2, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, False, 0.3, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, False, 0.3, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, False, 0.4, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, False, 0.4, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, False, 0.5, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, False, 0.5, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, False, 0.6, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, False, 0.6, 0.36),
  ('same_day_antigen', 'student', None, None, True, True, False, 0.7, 0.36),
  ('same_day_antigen', 'teacher', None, None, True, True, False, 0.7, 0.36),
  # all measures
  ...
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.4, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.4, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.5, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.5, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.6, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.6, 0.36),
  ('same_day_antigen', 'student', 3, 3, True, True, False, 0.7, 0.36),
  ('same_day_antigen', 'teacher', 3, 3, True, True, False, 0.7, 0.36),
]
